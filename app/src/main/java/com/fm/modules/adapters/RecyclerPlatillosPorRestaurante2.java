...
public class RecyclerPlatillosPorRestaurante2 extends RecyclerView.Adapter<RecyclerPlatillosPorRestaurante2.ViewHolder> {
    ...
    public RecyclerPlatillosPorRestaurante2(Context context, List<Platillo> platillos, FragmentActivity fragmentActivity) {
