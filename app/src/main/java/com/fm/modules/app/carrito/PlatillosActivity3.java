...
import com.fm.modules.adapters.RecyclerPlatillosPorRestaurante2;
...
public class PlatillosActivity3 extends Fragment {
    private RecyclerView rvPlatillos;
    private View viewGlobal;
    private Menu menu;

    public PlatillosActivity3(Menu menu) {
        this.menu = menu;
    }
    ...
    public void verPlatillos() {
        ...
        if (idMenu != 0) {
            ...
            RecyclerPlatillosPorRestaurante2 recyclerPlatillosAdapter = new RecyclerPlatillosPorRestaurante2(viewGlobal.getContext(), platilloList, getActivity());
        ...
        if (GlobalRestaurantes.menuTabSelected != null) {
            ...
            showFragment2(new PlatillosActivity3(mm));
        }
    }
